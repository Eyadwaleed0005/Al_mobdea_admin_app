...
Future<bool> showCustomDeleteConfirmationBottomSheet(
  ...
  final bool? result = await showModalBottomSheet<bool>(
    ...
    barrierColor: ColorPalette.textPrimary.withValues(
      alpha: 0.35,
    ),
...
class CustomDeleteConfirmationBottomSheet
...
class _CustomDeleteConfirmationBottomSheetState
  ...
  Widget build(BuildContext context) {
    final double bottomSafeArea = MediaQuery.paddingOf(context)
        .bottom;
    ...
    return SizedBox(
      ...
      child: OutlinedButton(
        ...
        style: OutlinedButton.styleFrom(
          ...
          disabledForegroundColor: ColorPalette.primary
