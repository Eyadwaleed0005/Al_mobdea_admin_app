...
class _AppNetworkStatusListenerState
  ...
  bool get _canCheckNetworkStatus {
    final routeName =
        widget.routeObserver.currentRouteName.value;

    return routeName != null &&
        routeName != RouteNames.splashScreen;
  }
  ...
  void initState() {
    ...
    widget.routeObserver.currentRouteName.addListener(
      _handleRouteChanged,
    );
  }
  ...
  void didUpdateWidget(
    covariant AppNetworkStatusListener oldWidget,
  ) {
  ...
  @override
  void dispose() {
    widget.routeObserver.currentRouteName.removeListener(
      _handleRouteChanged,
    );
