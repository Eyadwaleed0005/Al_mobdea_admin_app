...
class FirebaseStorageService implements StorageService {
  ...
  Future<FullMetadata> uploadFile({
    ...
    final String normalizedStoragePath = _normalizeStoragePath(
      storagePath,
    );
      ...
      action: () async {
        ...
        if (!fileExists) {
          throw FirebaseException(
            ...
            message:
                'The selected local file could not be found.',
          );
        }
        ...
        final StreamSubscription<TaskSnapshot>?
        progressSubscription = _listenToUploadProgress(
        ...
        try {
          ...
          final FullMetadata? uploadedMetadata =
              snapshot.metadata;
  ...
  StreamSubscription<TaskSnapshot>? _listenToUploadProgress({
    ...
    return uploadTask.snapshotEvents.listen((
  ...
  void _logResponse({
    ...
    if (logResponseData) {
      buffer
        ...
        ..writeln(
          _addLinePrefix(
            _prettyPrint(_formatResponse(response)),
          ),
        );
    }
