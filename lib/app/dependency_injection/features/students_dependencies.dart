...
// TODO: Uncomment and wire these registrations when the Firebase project is
// created and firebase_options.dart exists. The data & domain layers are fully
// implemented and unit-tested; only the real Firebase binding is deferred.
//
...
void registerStudentsDependencies(GetIt getIt) {
  // TODO: Will be bound when the Firebase project is created.
  //
  // // Data sources
