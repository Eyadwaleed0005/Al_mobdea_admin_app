...
class FirebaseExamsRemoteDataSource implements ExamsRemoteDataSource {
  const FirebaseExamsRemoteDataSource({
    required ExamQueryService examQueryService,
    required ExamResultsQueryService examResultsQueryService,
    required ExamCreationService examCreationService,
    required ExamUpdateService examUpdateService,
    required ExamDeletionService examDeletionService,
  }) : _examQueryService = examQueryService,
       _examResultsQueryService = examResultsQueryService,
       _examCreationService = examCreationService,
       _examUpdateService = examUpdateService,
       _examDeletionService = examDeletionService;
