...
class ExamResultModel extends ExamResultEntity {
  ...
  factory ExamResultModel.fromMap({
    ...
    return ExamResultModel(
      ...
      studentId: _readString(data[FirestoreFields.studentId]),
      studentName: _readString(data[FirestoreFields.studentName]),
      gradeId: _readString(data[FirestoreFields.gradeId]),
      gradeName: _readString(data[FirestoreFields.gradeName]),
      score: score,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      FirestoreFields.startedAt: Timestamp.fromDate(startedAt),
  ...
  static String statusToJson(ExamAttemptStatus status) {
