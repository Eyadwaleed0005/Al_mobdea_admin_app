...
import 'package:al_mobdea_admin/features/exams/data/validation/core/constants/exam_feature_messages.dart';
...
class ExamUpdateService {
  const ExamUpdateService({
    ...
    required ExamFirestoreGuardService examFirestoreGuardService,
    required ExamQuestionImageService examQuestionImageService,
  }) : _firebaseFirestore = firebaseFirestore,
       _examsDataValidator = examsDataValidator,
       _examFirestoreGuardService = examFirestoreGuardService,
  ...
  Future<void> updateExam({required ExamModel exam}) async {
  ...
  Future<void> updateQuestion({
    ...
    final ExamQuestionModel initialQuestion = _examFirestoreGuardService
        .requireExamQuestion(initialQuestionSnapshot, examId: examId);
  ...
  Future<bool?> _verifyQuestionUpdate({
    ...
    try {
      ...
      final bool questionDataMatches =
          ...
          _choicesMatch(savedQuestion.choices, expectedQuestion.choices) &&
  ...
  bool _choicesMatch(List<String> firstChoices, List<String> secondChoices) {
