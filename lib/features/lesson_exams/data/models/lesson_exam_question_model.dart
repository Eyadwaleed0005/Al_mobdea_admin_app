...
class LessonExamQuestionModel extends LessonExamQuestionEntity {
  ...
  factory LessonExamQuestionModel.fromMap({
    ...
    return LessonExamQuestionModel(
      ...
      correctChoiceIndex: _readNullableInt(
        map[FirestoreFields.correctOption],
      ),
      imageUrl: _readNullableString(
        map[FirestoreFields.questionImageUrl],
      ),
  ...
  factory LessonExamQuestionModel.fromEntity(
    LessonExamQuestionEntity entity,
  ) {
    return LessonExamQuestionModel(
  ...
  Map<String, dynamic> toCreateMap() {
    return {
      FirestoreFields.lessonId: lessonId.trim(),
      FirestoreFields.questionText: questionText.trim(),
