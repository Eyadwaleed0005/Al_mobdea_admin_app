...
class LessonExamEntity {
  ...
  bool get hasQuestionsWithoutCorrectAnswer {
    return questions.any((question) => !question.hasCorrectChoice);
  }

  bool get allQuestionsHaveCorrectAnswers {
    return questions.isNotEmpty &&
        questions.every((question) => question.hasCorrectChoice);
  }
  ...
  factory LessonExamEntity.empty({required String lessonId}) {
    return LessonExamEntity(
      lessonId: lessonId,
      questions: const [],
    );
